...
function hook_woocommerce_events() {
    ...
    add_action('woocommerce_update_product', 'handle_product_update', 10, 1);
    add_action('before_delete_post', 'handle_delete_product', 10, 1);
    add_action('woocommerce_created_customer', 'handle_new_customer', 10, 3);
    add_action('woocommerce_add_to_cart', 'handle_add_to_cart', 10, 6);
    add_action('woocommerce_cart_item_removed', 'handle_cart_item_removed', 10, 2);
}
...
function handle_new_customer($customer_id, $new_customer_data, $password_generated) {
...
function handle_cart_item_removed($cart_item_key, $cart) {
    $event = array(
